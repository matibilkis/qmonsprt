...
LL= 6
limx = np.argmin(np.abs(xnume_det - LL))
limxseq = np.argmin(np.abs(xnumer_seq - LL))
xnumer_seq = xnumer_seq[:limxseq]
xnume_det = xnume_det[:limx]

ynumer_seq = ynumer_seq[:limxseq]
ynume_det = ynume_det[:limx]
